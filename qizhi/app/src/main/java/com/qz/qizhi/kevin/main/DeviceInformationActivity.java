...
public class DeviceInformationActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(Res.layout.activity_device_info);
		initView();
	}
	...
	private void initView() {
		...
		deviceIDtxt = (TextView) findViewById(Res.id.deviceIDTxt);
		versionTxt = (TextView) findViewById(Res.id.deviceVersionTxt);
	}
