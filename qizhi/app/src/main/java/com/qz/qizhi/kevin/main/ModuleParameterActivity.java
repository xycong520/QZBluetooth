...
public class ModuleParameterActivity extends BaseActivity implements
		BLEDevice.RFStarBLEBroadcastReceiver, PopListView.PopChioceListViewClickListener,
		OnClickListener {
...
//		this.initNavigation(member.name);
		...
		ff93Layout = (LinearLayout) findViewById(Res.id.FF93Layout);
		ff94Layout = (LinearLayout) findViewById(Res.id.FF94Layout);
		ff95Layout = (LinearLayout) findViewById(Res.id.FF95Layout);
		ff97Layout = (LinearLayout) findViewById(Res.id.FF97Layout);
		ff99Layout = (LinearLayout) findViewById(Res.id.FF99Layout);
		ff9aLayout = (LinearLayout) findViewById(Res.id.FF9ALayout);
		...
		ff91Txt = (TextView) findViewById(Res.id.FF91Txt);
		ff92Txt = (TextView) findViewById(Res.id.FF92Txt);
		ff93Txt = (TextView) findViewById(Res.id.FF93Txt);
		ff94Txt = (TextView) findViewById(Res.id.FF94Txt);
		ff95Txt = (TextView) findViewById(Res.id.FF95Txt);
		ff96Txt = (TextView) findViewById(Res.id.FF96Txt);
		ff97Txt = (TextView) findViewById(Res.id.FF97Txt);
		ff98Txt = (TextView) findViewById(Res.id.FF98Txt);
		ff99Txt = (TextView) findViewById(Res.id.FF99Txt);
		ff9aTxt = (TextView) findViewById(Res.id.FF9ATxt);

		ff91Edit = (EditText) findViewById(Res.id.FF91Edit);
		ff96Edit = (EditText) findViewById(Res.id.FF96Edit);
		ff98Edit = (EditText) findViewById(Res.id.FF98Edit);
