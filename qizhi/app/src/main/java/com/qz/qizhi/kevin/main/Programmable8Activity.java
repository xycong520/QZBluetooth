...
import com.qz.qizhi.kevin.tools.Tools;
...
public class Programmable8Activity extends BaseActivity implements
		BLEDevice.RFStarBLEBroadcastReceiver, OnCheckedChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(Res.layout.activity_programmable8);
		this.initView();
	}
	...
	private void initView() {
		...
		setBox0 = (CheckBox) findViewById(Res.id.ioSetBox0);
		setBox1 = (CheckBox) findViewById(Res.id.ioSetBox1);
		setBox2 = (CheckBox) findViewById(Res.id.ioSetBox2);
		setBox3 = (CheckBox) findViewById(Res.id.ioSetBox3);
		setBox4 = (CheckBox) findViewById(Res.id.ioSetBox4);
		setBox5 = (CheckBox) findViewById(Res.id.ioSetBox5);
		setBox6 = (CheckBox) findViewById(Res.id.ioSetBox6);
		setBox7 = (CheckBox) findViewById(Res.id.ioSetBox7);

		outBox0 = (CheckBox) findViewById(Res.id.ioOutBox0);
		outBox1 = (CheckBox) findViewById(Res.id.ioOutBox1);
		outBox2 = (CheckBox) findViewById(Res.id.ioOutBox2);
		outBox3 = (CheckBox) findViewById(Res.id.ioOutBox3);
		outBox4 = (CheckBox) findViewById(Res.id.ioOutBox4);
		outBox5 = (CheckBox) findViewById(Res.id.ioOutBox5);
		outBox6 = (CheckBox) findViewById(Res.id.ioOutBox6);
		outBox7 = (CheckBox) findViewById(Res.id.ioOutBox7);

		inBox0 = (CheckBox) findViewById(Res.id.ioInBox0);
		inBox1 = (CheckBox) findViewById(Res.id.ioInBox1);
		inBox2 = (CheckBox) findViewById(Res.id.ioInBox2);
		inBox3 = (CheckBox) findViewById(Res.id.ioInBox3);
		inBox4 = (CheckBox) findViewById(Res.id.ioInBox4);
		inBox5 = (CheckBox) findViewById(Res.id.ioInBox5);
		...
		setTxt = (TextView) findViewById(Res.id.setTxt);
		outTxt = (TextView) findViewById(Res.id.outTxt);
		inTxt = (TextView) findViewById(Res.id.inTxt);
