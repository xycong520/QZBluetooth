...
public class RssiActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(Res.layout.activity_rssi);
		this.initView();
	}
	...
	private void initView() {
		...
		rssiTxt = (TextView) findViewById(Res.id.rssiTxt);
		rssiEdit = (EditText) findViewById(Res.id.rssiEdit);
		rssiCircleTxt = (TextView) findViewById(Res.id.rssiCircleTxt);
	}
