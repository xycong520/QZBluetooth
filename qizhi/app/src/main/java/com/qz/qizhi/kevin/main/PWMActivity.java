...
import com.qz.qizhi.kevin.view.SegmentViewController;
...
public class PWMActivity extends BaseActivity implements
		OnSeekBarChangeListener, SegmentViewController.SegmentViewControllerClickListener,
		OnClickListener, BLEDevice.RFStarBLEBroadcastReceiver {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(Res.layout.activity_pwm);
		this.initView();
	}
	...
	private void initView() {
		...
		this.segmentLayout = (LinearLayout) this
				.findViewById(Res.id.segmentLayout);
		...
		this.contentLayout = (LinearLayout) this
				.findViewById(Res.id.contentLayout);
	...
	private View seekBarInit(SeekBar bar, String label) {
		...
		seekbarLayout.setBackgroundResource(Res.drawable.seek_layout_bg);
	...
	private View changeTimeWidthseekBarInit(SeekBar bar, String label) {
		...
		onBtn.setBackgroundResource(Res.drawable.button_item_click);
		offBtn.setBackgroundResource(Res.drawable.button_item_click);
